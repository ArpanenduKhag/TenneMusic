    ...
    try {
      if (args[0]) {
        ...
        const embed = new MessageEmbed()
          ...
          .addField(
            "• Developer",
            `\`\`\`yml\nName: ᴮᶜˢ TENNESSINE07#9928 [732247781447565402]\nName Ξ Tennessine07 [732247781447565402]\`\`\``
          )
          .addField(
            "• Important Links",
            `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support 0Server](https://discord.gg/HsFVamFb4N)\`|\`[Youtube](https://www.youtube.com/channel/UCtpA93OoN2aP_8xJS0DuGSg)\`**`
          )
          .setFooter(
            `To see command descriptions and inforamtion, type: ${config.prefix}help [CMD NAME]`,
            client.user.displayAvatarURL()
