  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("TenneMusic | Music Queue")
        .setImage("https://cdn.discordapp.com/attachments/890927303188701188/890935737514622976/TenneMusic.gif")
        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("TenneMusic | Currently no song is playing!")
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n[Invite TenneMusic](https://discord.com/api/oauth2/authorize?client_id=890073838472282133&permissions=339209328&scope=bot) • [Support Server](https://discord.gg/HsFVamFb4N) • [Website](https://www.youtube.com/channel/UCtpA93OoN2aP_8xJS0DuGSg)`)
        .setImage("https://cdn.discordapp.com/avatars/890073838472282133/f29fe10f3bfe32aaf4412efd0266ac2a.png?size=512")
    ...
    function SongEmbed(track) {
      ...
      let embed = new MessageEmbed()
        ...
        embed.setTitle(`<a:tenneloading:892757941957038101> Progress:`)
        embed.setDescription(`${createBarlul(player)}`)
        embed.addField("<a:Playing:892752015267086336> **Song By:**", `\`${track.author}\``, true)
        embed.addField(`<a:Loading:892762629783842817> **State**`, `\`${player.play_pause ? `${emoji.msg.resume}  Paused` : `${emoji.msg.pause}  Playing`}\``, true)
        embed.addField(`<a:tmloading:892760729076260944> **Requested by:**`, `${track.requester}`, true)
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`TenneMusic | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
      embed.setImage("https://cdn.discordapp.com/attachments/890927303188701188/890935737514622976/TenneMusic.gif");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
